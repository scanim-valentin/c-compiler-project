...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    tDiv = 266,
    tEqual = 267,
    tOpeningParenthesis = 268,
    tClosingParenthesis = 269,
    tNewline = 270,
    tPointVirgule = 271,
    tValueInt = 272,
    tVarName = 273,
...
#define tDiv 266
#define tEqual 267
#define tOpeningParenthesis 268
#define tClosingParenthesis 269
#define tNewline 270
#define tPointVirgule 271
#define tValueInt 272
#define tVarName 273
#define tValueExp 274
...
static const char *const yytname[] =
{
  ...
  "tOpeningBracket", "tClosingBracket", "tMain", "tPlus", "tMinus",
  "tMult", "tDiv", "tEqual", "tOpeningParenthesis", "tClosingParenthesis",
  "tNewline", "tPointVirgule", "tValueInt", "tVarName", "tValueExp",
  "$accept", "PROGRAMME", "CORPS", YY_NULLPTR
};
#endif
